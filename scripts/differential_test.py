...
SUITES = [
    ...
    ("zset: set operations", [
        ("DEL", "zo1", "zo2"),
        ("ZADD", "zo1", "1", "a", "2", "b", "3", "c"),
        ("ZADD", "zo2", "10", "b", "20", "c", "30", "d"),
        ("ZUNION", "2", "zo1", "zo2"),
        ("ZUNION", "2", "zo1", "zo2", "WITHSCORES"),
        ("ZINTER", "2", "zo1", "zo2", "WITHSCORES"),
        ("ZDIFF", "2", "zo1", "zo2", "WITHSCORES"),
        ("ZDIFF", "2", "zo2", "zo1", "WITHSCORES"),
        ("ZUNION", "2", "zo1", "zo2", "WEIGHTS", "2", "3", "WITHSCORES"),
        ("ZUNION", "2", "zo1", "zo2", "AGGREGATE", "MIN", "WITHSCORES"),
        ("ZUNION", "2", "zo1", "zo2", "AGGREGATE", "MAX", "WITHSCORES"),
        ("ZINTER", "2", "zo1", "zo2", "AGGREGATE", "MIN", "WITHSCORES"),
        ("ZINTER", "2", "zo1", "zo2", "AGGREGATE", "MAX", "WITHSCORES"),
        ("ZUNION", "2", "zo1", "zo2", "WEIGHTS", "0", "0", "WITHSCORES"),
        ("ZUNION", "1", "zo1", "WEIGHTS", "-1", "WITHSCORES"),
        ("ZUNION", "1", "zo1", "WEIGHTS", "inf", "WITHSCORES"),
        ("ZINTERCARD", "2", "zo1", "zo2"),
        ("ZINTERCARD", "2", "zo1", "zo2", "LIMIT", "1"),
        ("ZINTERCARD", "2", "zo1", "zo2", "LIMIT", "0"),
        ("ZINTERCARD", "1", "zo1"),
        # A missing key is an empty input, not an error.
        ("ZUNION", "2", "zo1", "missing_zo", "WITHSCORES"),
        ("ZINTER", "2", "zo1", "missing_zo", "WITHSCORES"),
        ("ZDIFF", "2", "zo1", "missing_zo", "WITHSCORES"),
        ("ZINTERCARD", "2", "zo1", "missing_zo"),
        ("DEL", "zo1", "zo2"),
    ], {}),
    ("zset: set operations over plain sets", [
        ("DEL", "zs1", "ss1", "zs_out"),
        ("ZADD", "zs1", "1", "a", "2", "b"),
        ("SADD", "ss1", "b", "c"),
        # A set member enters at score 1, and a weight multiplies that 1.
        ("ZUNION", "2", "zs1", "ss1", "WITHSCORES"),
        ("ZINTER", "2", "zs1", "ss1", "WITHSCORES"),
        ("ZDIFF", "2", "zs1", "ss1", "WITHSCORES"),
        ("ZDIFF", "2", "ss1", "zs1", "WITHSCORES"),
        ("ZUNION", "2", "zs1", "ss1", "WEIGHTS", "1", "5", "WITHSCORES"),
        ("ZINTERCARD", "2", "zs1", "ss1"),
        ("ZUNIONSTORE", "zs_out", "2", "zs1", "ss1"),
        ("ZRANGE", "zs_out", "0", "-1", "WITHSCORES"),
        ("OBJECT", "ENCODING", "zs_out"),
        ("DEL", "zs1", "ss1", "zs_out"),
    ], {}),
    ("zset: store operations", [
        ("DEL", "zo1", "zo2", "zo_dst"),
        ("ZADD", "zo1", "1", "a", "2", "b", "3", "c"),
        ("ZADD", "zo2", "10", "b", "20", "c", "30", "d"),
        ("ZUNIONSTORE", "zo_dst", "2", "zo1", "zo2"),
        ("ZRANGE", "zo_dst", "0", "-1", "WITHSCORES"),
        ("OBJECT", "ENCODING", "zo_dst"),
        ("ZINTERSTORE", "zo_dst", "2", "zo1", "zo2", "AGGREGATE", "MAX"),
        ("ZRANGE", "zo_dst", "0", "-1", "WITHSCORES"),
        ("ZDIFFSTORE", "zo_dst", "2", "zo1", "zo2"),
        ("ZRANGE", "zo_dst", "0", "-1", "WITHSCORES"),
        ("ZUNIONSTORE", "zo_dst", "2", "zo1", "zo2", "WEIGHTS", "2", "0.5"),
        ("ZRANGE", "zo_dst", "0", "-1", "WITHSCORES"),
        # An empty result deletes the destination rather than storing nothing.
        ("ZINTERSTORE", "zo_dst", "2", "zo1", "missing_zo"),
        ("EXISTS", "zo_dst"),
        ("ZDIFFSTORE", "zo_dst", "2", "zo1", "zo1"),
        ("EXISTS", "zo_dst"),
        ("ZUNIONSTORE", "zo_dst", "1", "missing_zo"),
        ("EXISTS", "zo_dst"),
        # The destination is replaced outright, whatever type it held.
        ("SET", "zo_dst", "v"),
        ("ZUNIONSTORE", "zo_dst", "1", "zo1"),
        ("TYPE", "zo_dst"),
        ("DEL", "zo1", "zo2", "zo_dst"),
    ], {}),
    ("zset: set operation errors", [
        ("DEL", "ze1", "ze_dst"), ("ZADD", "ze1", "1", "a"),
        ("ZUNION", "0", "ze1"),
        ("ZINTER", "0", "ze1"),
        ("ZDIFF", "0", "ze1"),
        ("ZUNIONSTORE", "ze_dst", "0", "ze1"),
        ("ZINTERSTORE", "ze_dst", "0", "ze1"),
        ("ZDIFFSTORE", "ze_dst", "0", "ze1"),
        ("ZUNION", "notanumber", "ze1"),
        ("ZUNION", "-1", "ze1"),
        ("ZINTERCARD", "0", "ze1"),
        ("ZINTERCARD", "notanumber", "ze1"),
        ("ZUNION", "3", "ze1"),
        ("ZUNIONSTORE", "ze_dst", "3", "ze1"),
        ("ZINTERCARD", "3", "ze1"),
        ("ZUNION", "1", "ze1", "WEIGHTS", "nan"),
        ("ZUNION", "1", "ze1", "WEIGHTS", "abc"),
        ("ZUNION", "1", "ze1", "WEIGHTS"),
        ("ZUNION", "1", "ze1", "AGGREGATE", "BOGUS"),
        ("ZUNION", "1", "ze1", "AGGREGATE"),
        ("ZUNION", "1", "ze1", "BOGUS"),
        # ZDIFF combines nothing, so it takes neither of them.
        ("ZDIFF", "1", "ze1", "WEIGHTS", "2"),
        ("ZDIFF", "1", "ze1", "AGGREGATE", "MIN"),
        ("ZUNIONSTORE", "ze_dst", "1", "ze1", "WITHSCORES"),
        ("ZINTERCARD", "1", "ze1", "LIMIT", "-1"),
        ("ZINTERCARD", "1", "ze1", "LIMIT"),
        ("ZINTERCARD", "1", "ze1", "BOGUS", "1"),
        ("ZUNION", "1"),
        ("ZINTERCARD", "1"),
        ("ZUNIONSTORE", "ze_dst", "1"),
        ("SET", "ze_str", "v"),
        ("ZUNION", "2", "ze1", "ze_str"),
        ("ZINTER", "2", "ze_str", "ze1"),
        ("ZDIFF", "2", "ze1", "ze_str"),
        ("ZINTERCARD", "2", "ze1", "ze_str"),
        ("ZUNIONSTORE", "ze_dst", "2", "ze1", "ze_str"),
        # WRONGTYPE among the inputs beats a syntax error in the options.
        ("ZUNION", "2", "ze1", "ze_str", "BOGUS"),
        ("DEL", "ze1", "ze_str", "ze_dst"),
    ], {}),
    ("zset: zmpop", [
        ("DEL", "zp1", "zp2"),
        ("ZADD", "zp1", "1", "a", "2", "b", "3", "c"),
        ("ZADD", "zp2", "10", "x", "20", "y"),
        ("ZMPOP", "2", "zp1", "zp2", "MIN"),
        ("ZMPOP", "2", "zp1", "zp2", "MAX"),
        ("ZMPOP", "2", "zp1", "zp2", "MIN", "COUNT", "2"),
        ("EXISTS", "zp1"),
        # zp1 is gone, so the second key is reached for the first time.
        ("ZMPOP", "2", "zp1", "zp2", "MAX", "COUNT", "10"),
        ("EXISTS", "zp2"),
        ("ZMPOP", "2", "zp1", "zp2", "MIN"),
        ("ZMPOP", "1", "missing_zp", "MIN"),
        ("ZMPOP", "0", "zp1", "MIN"),
        ("ZMPOP", "notanumber", "zp1", "MIN"),
        ("ZMPOP", "2", "zp1", "MIN"),
        ("ZADD", "zp1", "1", "a"),
        ("ZMPOP", "1", "zp1", "BOGUS"),
        ("ZMPOP", "1", "zp1", "MIN", "COUNT", "0"),
        ("ZMPOP", "1", "zp1", "MIN", "COUNT", "-1"),
        ("ZMPOP", "1", "zp1", "MIN", "COUNT"),
        ("ZMPOP", "1", "zp1", "MIN", "BOGUS", "1"),
        ("ZMPOP", "1", "zp1"),
        ("SET", "zp_str", "v"),
        ("ZMPOP", "1", "zp_str", "MIN"),
        ("ZMPOP", "2", "zp_str", "zp1", "MIN"),
        ("DEL", "zp1", "zp2", "zp_str"),
    ], {}),
    ("zset: basics", [
    ...
    ("keyspace: zset set-operation events", [
        (0, "DEL", "kO1", "kO2", "kOD"),
        (0, "CONFIG", "SET", "notify-keyspace-events", "KEgz"),
        (1, "PSUBSCRIBE", "__keyevent@0__:*"),
        (0, "ZADD", "kO1", "1", "a", "2", "b"), (1, "@recv"),
        (0, "ZADD", "kO2", "3", "b"), (1, "@recv"),
        # The store variants name their event after themselves, not after zadd.
        (0, "ZUNIONSTORE", "kOD", "2", "kO1", "kO2"), (1, "@recv"),
        (0, "ZINTERSTORE", "kOD", "2", "kO1", "kO2"), (1, "@recv"),
        (0, "ZDIFFSTORE", "kOD", "2", "kO1", "kO1"), (1, "@recv"),
        (0, "ZDIFFSTORE", "kOD", "2", "kO1", "kO1"),
        # ZMPOP announces the pop it actually did, under zpopmin/zpopmax.
        (0, "ZMPOP", "2", "kO1", "kO2", "MIN"), (1, "@recv"),
        (0, "ZMPOP", "2", "kO1", "kO2", "MAX"), (1, "@recv"), (1, "@recv"),
        (0, "ZMPOP", "2", "kO1", "kO2", "MIN"), (1, "@recv"), (1, "@recv"),
        (1, "PUNSUBSCRIBE"),
        (0, "CONFIG", "SET", "notify-keyspace-events", ""),
    ], {"two_clients": True}),
